      ...
      <>
        <ContentSection>
          ...
          <P style={{ marginTop: '16px' }}>
            상세 페이지 내용이 여기에 표시됩니다. 최대 너비 672px로 제한되어 있습니다.
          </P>
        </ContentSection>
        <ContentSection>
          <H2>섹션 1</H2>
  ...
  render: () => (
    <DetailPageLayout>
      <ContentSection>
        ...
        <P style={{ marginTop: '16px', color: '#687CF4', fontWeight: 600 }}>
          패션 브랜드
        </P>
        <P style={{ marginTop: '8px' }}>
          패션 쇼와 광고 촬영에 참여할 모델을 모집합니다.
        </P>
      </ContentSection>
      <ContentSection>
        <H2>모집 내용</H2>
  ...
  render: () => (
    <DetailPageLayout>
      ...
      <ContentSection>
        <H2>경력</H2>
        <P style={{ marginTop: '8px' }}>
          - 2019년 ~ 현재: 프리랜스 패션 모델<br />
          - 주요 작품: 패션 잡지, 광고 촬영 다수
        </P>
      </ContentSection>
      <ContentSection>
        <H2>작품</H2>
          ...
          <P style={{ marginTop: '8px' }}>
            {Array.from({ length: 5 }, (_, j) => (
              <React.Fragment key={j}>
                이것은 {i + 1}번째 섹션의 {j + 1}번째 문단입니다. 
                상세 페이지 레이아웃은 최대 너비 672px로 제한되어 있어 
                가독성을 유지합니다.
                <br />
              </React.Fragment>
            ))}
