...
export const ModelListPageRoot = styled.div`
  min-height: 100vh;
  background: ${({ theme }) => theme.colors.surface};
  color: ${({ theme }) => theme.colors.text};
`;

export const ModelListMain = styled.main`
...
export const ModelFilterBar = styled.section`
  display: flex;
  gap: 8px;
  overflow-x: auto;
  margin: 16px -16px 0;
...
export const ModelListSection = styled.section`
  margin: 22px -16px 0;
...
export const ModelListCardLink = styled(Link)`
  overflow: hidden;
...
export const ModelCardImage = styled.div`
  overflow: hidden;
  aspect-ratio: 3 / 4;
  background: #f7f5fb;
...
export const ModelCardBody = styled.div`
  padding: 12px;
`;

export const ModelCardTitleRow = styled.div`
  display: flex;
  align-items: center;
  gap: 6px;
...
export const ModelInlineChip = styled.span`
  flex: 0 0 auto;
  display: inline-flex;
  align-items: center;
  min-height: 20px;
...
export const ModelMessageIcon = styled.span`
  flex: 0 0 auto;
  display: inline-grid;
  place-items: center;
  width: 20px;
...
export const ModelCardSummary = styled.p`
  min-height: 3.84em;
  margin: 8px 0 0;
  overflow: hidden;
  color: ${({ theme }) => theme.colors.subText};
...
export const ModelCardMeta = styled.div`
  display: flex;
  flex-wrap: wrap;
  gap: 6px;
  margin-top: 11px;
...
export const ModelRegisterFab = styled.button`
  position: fixed;
  right: 18px;
  bottom: 92px;
  z-index: 70;
